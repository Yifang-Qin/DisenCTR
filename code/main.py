...
from ctr_model import CTR_Model_HAW
from dataloader import Haw_data, collate_HAW
...
def train_test(model, tr_set, va_set, te_set, arg, device):
    ...
    for epoch in range(arg.epoch):
        ...
        logging.info(f'Best valid AUC: {best_auc} at epch {best_epoch}, test AUC: {auc_test}, loss: {logloss_test}, ndcg@10: {ndcg10_test}\n')
...
if __name__ == '__main__':  
    ...
    train_test(model, tr_ds, va_ds, te_ds, ARG, device)
